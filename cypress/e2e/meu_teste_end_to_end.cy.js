...
describe('Teste End-to-End - Compra de um Livro', () => {
    it('Teste 1: Visita Página', () => {
        // abre o site
        cy.visit('http://localhost:5000/')
    })
    ...
    it('Teste 3: Compra o Livro', () => {    
        // Compra o Livro Engenharia De Software Moderna
        ...
        // Fecha o pop-up com aviso de compra do Livro
        cy.get('.swal-button').click()
    })
})
